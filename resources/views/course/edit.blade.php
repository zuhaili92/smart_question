...
<div class="row bg-title">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="white-box">
                <h3 class="box-title m-b-0">Edit Course</h3>
                ...
                {{ csrf_field() }}
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="text" class="form-control" name="course_name" value="{{$course->course_name}}" required=""> </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-12">Folders :</label>
                            <div class="col-md-12">
                            @php ($no=1)
                            <?php $folder_id = explode(" , ",$course->folder_id); ?>
                                @foreach($folders as $folder)
                                    <div class="checkbox checkbox-success">
                                        <input id="{{$no}}" value="{{$folder->id}}" name="folder_id[]" type="checkbox" <?php if(in_array($folder->id, $folder_id)) { echo "checked"; } ?>>
